...
from torch_geometric.nn.glob.gqp import Graph_Quadratic_Pooling
from torch_geometric.nn.conv.gqt import GQT
...
class Q_GAT(torch.nn.Module):
	def __init__(self, num_features,nhid,num_classes,concat=False):
		...
		self.conv1 = GQT(self.num_features, self.nhid * 2)
		self.conv2 = GQT(self.nhid * 2, self.nhid * 2)
	...
	def forward(self, data):
		...
		x = F.selu(Graph_Quadratic_Pooling(x, batch))
